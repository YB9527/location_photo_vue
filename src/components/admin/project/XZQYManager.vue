  ...
  <div>
    ...
    <el-menu
      ...
      <el-submenu index="3" :disabled="project.xzdms && project.xzdms.length >0?false:true">
        ...
        <el-menu-item index="3-1" @click="showXZDMTable">1、区域分配任务</el-menu-item>
        <el-menu-item index="3-2" @click="findXZDMZJDAll">2、单个地块任务</el-menu-item>
      </el-submenu>
      ...
      <el-menu-item index="5" :disabled="multipleSelection.length === 0 " style="float: right"
                    v-show="activeIndex === '3-1' || activeIndex === '5'"
    ...
    <el-table :data="project.xzdms" :height="tableheight" border style="text-align: center" v-if="showtable"
      ...
      <el-table-column
        v-if="activeIndex === '3-1' || activeIndex === '5' "
        type="selection"
        width="55">
      </el-table-column>
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          <el-button type="info" size="mini" v-show="activeIndex === '3-2'"
                     :disabled="!scope.row.zjds || scope.row.zjds.length ===0"
                     @click="dispathTak(scope.$index, scope.row)" plain>以地块分配
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-table :data="zjdtasks" :height="tableheight" border style="text-align: center" v-if="zjdtableshow"
      ...
      <el-table-column property="QUANLI" label="权利人" width="300px"></el-table-column>

      <el-table-column property="QUANLI" label="任务发放时间"></el-table-column>
      <el-table-column property="QUANLI" label="任务完成时间"></el-table-column>
      <el-table-column
        type="selection"
        width="55">
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-button type="warning" size="mini" v-show="activeIndex === '3-2'"
                     :disabled="!scope.row.zjds || scope.row.zjds.length ===0"
                     @click="dispathzjdTak(scope.$index, scope.row)" plain>选择
          </el-button>
        </template>
      </el-table-column>
    </el-table>

    <div style="float: left" v-show="showtable">
